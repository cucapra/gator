...
\newcommand{\topm}{\top_{n_1{\times}n_2}}
\newcommand{\topv}{\top_n}
...
\mu&::=& \mat \;|\;\vv{n}\;|\;T\\
\tau&::=&\mathsf{unit}\;|\;\mathsf{scalar}\;|\; \mu \;|\; \tau_1->\tau_2\\
c&::=&s\;|\;m\;|\;v\;|\;()\\
...
Vectors have a top type representing general vectors of dimension $n$ as $\topv$.  Similarly, we can give the top type of transformation matrices, whose type is always given by $\mu_1->\mu_2$, to be $\topm$:
%
\begin{mathpar}
\inferrule
    {\Delta|-\mu_1\leq_\Delta\vv{n_1}\qquad\Delta|-\mu_2\leq_\Delta\vv{n_2}}
    {\Delta|-\mu_1->\mu_2\leq_\Delta\topm}
\end{mathpar}
...
\inferrule
	{\Gamma,\Delta|-e_1:\tau_1\qquad\Gamma,\Delta|-e_2:\mathsf{scalar}\qquad\tau_1\leq_\Delta\topm\qquad}
