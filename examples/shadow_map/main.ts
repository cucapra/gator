...
function main() {
  ...
  programLocations["aTexCoord"] = lgl.attribLoc(gl, program, "aTexCoord");
  ...
  function render(view: mat4, projection: mat4) {
    ...
    function drawObject(mesh: lgl.Mesh, model: mat4, colors: WebGLBuffer) {
      gl.uniformMatrix4fv(programLocations["uModel"], false, model);
      console.log(shadowFramebuffer);
      lgl.bind_attrib_buffer(gl, programLocations["aTexCoord"] as number, shadowFramebuffer as WebGLFramebuffer, 3);
    ...
    drawObject(teapot, teapotModel, shadowFramebuffer as WebGLFramebuffer);
